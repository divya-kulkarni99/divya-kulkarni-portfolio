        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-md leading-relaxed">
              Software Engineer with 3+ years of experience across financial and
              healthcare domains. Passionate about performant backends, clean
              APIs, and impactful products. Open to full-time roles and
              collaborations.
            </p>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-center gap-3 text-gray-700 dark:text-gray-300">
                <Mail size={18} />
                <a
                  href="mailto:divya.k8273@gmail.com"
                  className="hover:text-indigo-600 dark:hover:text-indigo-400 transition"
                >
                  divya.k8273@gmail.com
                </a>
              </div>
              {/* <div className="flex items-center gap-3 text-gray-700 dark:text-gray-300">
                <Phone size={18} />
            ...
            <div className="flex gap-4 mt-6">
              {[
                {
                  href: 'https://github.com/divya-kulkarni99',
                  icon: <Github size={20} />,
                },
                {
                  href: 'https://linkedin.com/in/kuldivya',
              ...
              {[
                {
                  ...
                  description: 'DL-based forgery detection',
                },
                {
                  name: 'Blood Donation Portal',
                  description: 'QR registration + reporting',
                },
                {
                  name: 'NASA APOD App',
                  description: 'OAuth + API integration',
                },
              ].map((project, index) => (
                <li key={index}>
